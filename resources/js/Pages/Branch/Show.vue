    ...
    <div>
        <div class="flex items-center mb-4">
            ...
            <template v-if="this.$page.props.auth.roles.some(code => {
                         return [
                             `Admin`,
                             `Admin'.${branch.section_id}`,
                             `Admin'.${branch.section_id}.${branch.id}`,
                             `Admin'.${branch.section_id}.${branch.parent_id}`
                         ].includes(code)
                     })">
            <Link :href="route('branches.themes.create', branch.id)" class="block mr-4 w-1/6 px-2 py-1 bg-white border-gray-300 rounded-lg text-center">+ Тема</Link>
            </template>
        </div>
        <div class="mb-8">
            <div class="mb-4">
            ...
            <div v-for="branch in branch.children" class="flex items-center">
                <Link :href="route('branches.show', branch.id)" class="w-full flex items-center block bg-white p-4 border border-gray-300">
                    <div class="mr-4">
        ...
        <div>
            ...
            <div v-for="theme in branch.themes" class="flex items-center">
                ...
                <Link :href="route('themes.edit', theme.id)" class="block mx-2 bg-sky-600 p-4 rounded-full">
